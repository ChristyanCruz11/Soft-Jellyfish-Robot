...
function param = getDefaultParameters
  ...
  %param.motionNoise           = [1, 1, 1];
  %param.measurementNoise      = 25;
  param.measurementNoise      = 25;
  %param.segmentationThreshold = 0.05 original , va bien con 0.1;
  param.segmentationThreshold = 0.1;
end
...
function utilities = createUtilities(param)
  ...
  utilities.videoReader = vision.VideoFileReader('video7-1.wmv');
